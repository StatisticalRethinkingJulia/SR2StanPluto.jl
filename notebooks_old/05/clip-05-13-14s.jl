...
if success(rc5_4_MAs)
	begin
		...
		a = -2.5:0.1:3.0
		mu_MA = pmean(part5_4_MAs.a) .+ pmean(part5_4_MAs.bMA)*a
...
if success(rc5_4_AMs)
	begin
		m = -2.0:0.1:3.0
		mu_AM = pmean(part5_4_AMs.a) .+ pmean(part5_4_AMs.bAM)*m
...
if success(rc5_4_MAs)
	begin
		mu_MA_obs = pmean(part5_4_MAs.a) .+ pmean(part5_4_MAs.bMA)*df[:, :A_s]
...
if success(rc5_4_AMs)
	begin
		mu_AM_obs = pmean(part5_4_AMs.a) .+ pmean(part5_4_AMs.bAM)*df[:, :M_s]
