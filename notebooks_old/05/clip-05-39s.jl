...
# ╔═╡ a5357173-2a65-4247-96a6-b0f5b1d25fbb
begin
...
# ╔═╡ 6c0b3dfe-f1c3-47e3-a940-a1b0a42a3019
stan5_5 = "
data {
...
# ╔═╡ 38ee913f-685b-4380-b114-88175fe3b654
begin
	m5_5s = SampleModel("m5.5", stan5_5)
	rc5_5s = stan_sample(m5_5s; data)
end;

# ╔═╡ 08dbf329-651d-49e1-bb6e-d782b5e153b0
stan5_6 = "
data {
 int < lower = 1 > N; // Sample size
 vector[N] K; // Outcome
...
# ╔═╡ 6484a0f3-fbbe-4b03-aada-2c95d2ecf991
begin
	m5_6s = SampleModel("m5.6", stan5_6)
	rc5_6s = stan_sample(m5_6s; data)
end;

# ╔═╡ 8f02bd7e-7d93-4acb-99e8-df75019fa1c0
stan5_7 = "
data {
 int < lower = 1 > N; // Sample size
 vector[N] K; // Outcome
...
# ╔═╡ ae91353f-9f90-4a07-befb-50bb5564bdec
begin
