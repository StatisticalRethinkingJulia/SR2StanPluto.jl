...
begin
	...
	data = Dict("N" => size(df, 1), 
		"L" => df.perc_lactose_s, 
		"F" => df.perc_fat_s,
		"K" => 	df.kcal_per_g_s);
end;

# ╔═╡ b70f98ed-2447-4f72-b042-e09231b183d1
stan6_3 = "
data{
...
# ╔═╡ 2196bb14-ae6e-4c4f-a4e1-8b9853f1a6ab
begin
    m6_3s = SampleModel("m6.3", stan6_3);
    rc6_3s = stan_sample(m6_3s; data);
end

# ╔═╡ de986fbf-01b7-4788-98c0-eb13c7af13a3
stan6_4 = "
data{
    int <lower=1> N;              // Sample size
    vector[N] K;
...
# ╔═╡ e90ad276-2e83-4d34-a731-5b9992e297e8
