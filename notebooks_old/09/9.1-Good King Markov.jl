...
md" ### 9.1-Good King Markov.jl"

# ╔═╡ c101c831-3ab2-485e-8983-3711513ca967
md"
!!! note

This notebooks uses GLMakie for graphics."
...
let
    ...
    # Left graph
    ax = Axis(f[1, 1], title="Position in the first 100 weeks", ylabel="Island", xlabel="Week", ylimits=(1, 10))
