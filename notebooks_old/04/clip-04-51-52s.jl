...
begin
	...
	density!(quap4_3s_df.alpha + quap4_3s_df.beta * (30 - xbar), 
		lab="mu | weight=30")
	density!(quap4_3s_df.alpha + quap4_3s_df.beta * (50 - xbar), 
		lab="mu | weight=50")
	density!(quap4_3s_df.alpha + quap4_3s_df.beta * (70 - xbar), 
		lab="mu | weight=70")
end
