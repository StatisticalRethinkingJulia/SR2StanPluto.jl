...
begin
	...
	SR.scale!(waffles, [:Marriage, :MedianAgeMarriage, :Divorce])
...
let
	letters = ["A", "M", "D"]
	global f = Figure()
	ax = Axis(f[1, 1]; title="DAG 1: A -> M; A -> D; M -> D")
	...
	ax = Axis(f[1, 2]; title="DAG 2: A -> M; A -> D")
...
dsep(g2, 2, 3, [1], verbose=true)

# ╔═╡ 11e64b3b-1bb4-48dc-b0de-6a66f8e59ae5
dsep(g2, 1, 3, [2], verbose=true)
...
begin
	data = (N = size(df, 1), D = waffles.Divorce_s, M = waffles.Marriage_s,
...
LaTeXStrings = "~1.3.0"
Makie = "~0.19.2"
RegressionAndOtherStories = "~0.9.0"
StanQuap = "~4.2.4"
StanSample = "~7.1.1"
...
manifest_format = "2.0"
project_hash = "da04df046e5bef85a835370625b1c9cb2e9109a7"
...
git-tree-sha1 = "2e77803aba3596cf871cc7bdadd752eb953119d6"
uuid = "21324389-b050-441a-ba7b-9a837781bda0"
version = "0.9.0"
weakdeps = ["Makie", "StanSample"]
...
git-tree-sha1 = "a1a987a2dece63ac624a31c1f108dd4389f98ce1"
