...
# ╔═╡ baa611c5-cf4c-43eb-bba0-7e42d68beae8
begin
...
# ╔═╡ 2ed2e0a7-99be-462d-ba18-952da65cecdc
stan5_5 = "
data {
...
# ╔═╡ 685eedc6-f13d-4365-9bd4-00537700dd58
begin
	m5_5s = SampleModel("m5.5", stan5_5)
	rc5_5s = stan_sample(m5_5s; data)
end;

# ╔═╡ f232e079-4ab6-4cb9-8a06-b0bdf624a35c
stan5_6 = "
data {
 int < lower = 1 > N; // Sample size
 vector[N] K; // Outcome
...
# ╔═╡ cdc93ef2-5149-4b98-b152-d6ff83648276
begin
	m5_6s = SampleModel("m5.6", stan5_6)
	rc5_6s = stan_sample(m5_6s; data)
end;

# ╔═╡ f96d0687-6bdb-4806-bdbc-5a8404cd228f
stan5_7 = "
data {
 int < lower = 1 > N; // Sample size
 vector[N] K; // Outcome
...
# ╔═╡ 0eb1b9b9-1e9d-41ac-97da-dfa4af5504a6
begin
