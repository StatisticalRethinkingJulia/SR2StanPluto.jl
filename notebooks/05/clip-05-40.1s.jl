...
# ╔═╡ b7261094-3dc7-4da1-a92d-0c5e2520753d
begin
...
# ╔═╡ bbe9f620-3e61-4c61-ae03-685d259938e4
stan5_5 = "
data {
...
# ╔═╡ b408ff16-25e6-4e18-ae9d-facb87c8e939
begin
	m5_5s = SampleModel("m5.5", stan5_5)
	rc5_5s = stan_sample(m5_5s; data)
end;

# ╔═╡ 34372b4e-8029-4132-a485-269dfe7286b5
stan5_6 = "
data {
 int < lower = 1 > N; // Sample size
 vector[N] K; // Outcome
...
# ╔═╡ c4a030c5-32c3-4883-b273-4102f858a915
begin
	m5_6s = SampleModel("m5.6", stan5_6)
	rc5_6s = stan_sample(m5_6s; data)
end;

# ╔═╡ 763ce62b-6ade-465b-a1c7-589ba00c73a1
stan5_7 = "
data {
 int < lower = 1 > N; // Sample size
 vector[N] K; // Outcome
...
# ╔═╡ 35b841b4-4178-42bb-bb94-f8e656d56557
begin
