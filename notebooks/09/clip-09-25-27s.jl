...
begin
	...
	if success(rc9_4s)
		m9_4s_df = read_samples(m9_4s, :dataframe)
		PRECIS(m9_4s_df)
	end
end
...
begin
	chns9_4s = read_samples(m9_4s, :mcmcchains)
...
begin
	...
	if success(rc9_5s)
		m9_5s_df = read_samples(m9_5s, :dataframe)
		PRECIS(m9_5s_df)
	end
end
...
begin
	chns9_5s = read_samples(m9_5s, :mcmcchains)
